...
public class Rushi_Resume_upload{
	...
	public void test_01() throws IOException, InterruptedException{
		...
		npp.login("rushi.solleti@gmail.com", "Gupta@1994012");
//		npp.login("sudhaguttikonda28@gmail.com", "Sudha2811*");
		...
		Runtime.getRuntime().exec(projectPath+"\\src\\test\\resources\\AutoitFiles\\uploadExecutables\\Rushi_.exe");
		Thread.sleep(15000);
